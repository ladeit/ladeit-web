    ...
    render = ()=>{
        ...
        return (
            <Paper className={classes.root} elevation="16">
                <DialogTitle >
                    <Paper elevation="10" className={classes.topArea}><Typography variant="h5">{intl.get('login.registerTitle')}</Typography></Paper>
                </DialogTitle>
                <DialogContent className="content">
                    <form onKeyDown={this.clickKey} >
                        ...
                        <p>
                            <a className="link2" onClick={this.toUrl('/login')}>{intl.get('login.registerMemo')}</a>
