...
class Index extends React.PureComponent {
    ...
    state = {
        groupData:{},
        userList:{pageNum:1,pageSize:5,pageCount:0,records:[],totalPage:1},
        roleRow:{list:[]},
    ...
    render = ()=>{
        ...
        //if(userList.records.length){
        //    userList.records.push(userList.records[0])
        //    userList.records.push(userList.records[0])
        //    userList.records.push(userList.records[0])
        //    userList.records.push(userList.records[0])
        //}
                ...
                }
                {
                    userList.totalPage == 1 || (
                        <TablePagination
                            ...
                            component="div"
                            count={userList.totalRecord}
                            rowsPerPage={20}
                            page={userList.pageNum-1}
