...
function MainComponent(WComponent){
    ...
    class Index extends React.PureComponent {
        ...
        loadAll(pm){
            ...
            store.notification.loadRead(pm,function (pagination) {
                try{
        ...
        clickDetail = (row)=>{
            ...
            //
            History.push(`/notification/info/${row.id}?cate=read`)
        }
        ...
        onDelSelected = ()=>{
            let sc = this;
            let store = this.props.store;
            let data = store.notification.readData;
        ...
        onEvent = (name,data,event)=>{
            ...
            const readData = store.notification.readData;
            switch (name) {
                case "selected":{
                    store.notification.putSelected('readData',data);
                }
                    break;
                case "detail":{
                    let records = readData.records;
