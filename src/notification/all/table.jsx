...
function MainComponent(WComponent){
    ...
    class Index extends React.PureComponent {
        ...
        loadAll(pm){
            ...
            store.notification.loadAll(pm,function (pagination) {
                try{
        ...
        clickDetail = (row)=>{
            ...
            //
            History.push(`/notification/info/${row.id}?cate=all`)
        }

        onReadSelected = ()=>{
            let sc = this;
            let store = this.props.store;
            let data = store.notification.allData;
        ...
        onEvent = (name,data,event)=>{
            ...
            const allData = store.notification.allData;
            switch (name) {
                case "selected":{
                    store.notification.putSelected('allData',data);
                }
                    break;
                case "detail":{
