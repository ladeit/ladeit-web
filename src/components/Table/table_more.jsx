...
export default function EnhancedTable(props) {
    ...
    let tablePerPage = $table.perPage || props.rows.length;
    ...
    const [rows_loaded, setRowsLoaded] = React.useState(props.rows_loaded);
